...
const COLOR_LABELS: Partial<Record<keyof ThemeColors, { ru: string; ce: string }>> = {
  ...
  card: { ru: 'Карточки', ce: 'Карточкаш' },
  surface: { ru: 'Шапка и меню', ce: 'Корта а, меню а' },
  ...
  noteInfoBg: { ru: 'Подсказка — фон', ce: 'Хаам — букъ' },
  noteWarn: { ru: 'Предупреждение — текст', ce: 'Тидам — йоза' },
  noteWarnBg: { ru: 'Предупреждение — фон', ce: 'Тидам — букъ' },
  noteDanger: { ru: 'Опасность — текст', ce: 'Кхерам — йоза' },
  noteDangerBg: { ru: 'Опасность — фон', ce: 'Кхерам — букъ' },
  noteSuccess: { ru: 'Подтверждение — текст', ce: 'ТIечIагIдар — йоза' },
  noteSuccessBg: { ru: 'Подтверждение — фон', ce: 'ТIечIагIдар — букъ' },
};

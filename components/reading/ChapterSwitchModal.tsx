      ...
      <div className="smk-sheet w-full max-w-sm rounded-3xl p-5 shadow-2xl">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h2 id="reading-switch-title" className="text-base font-bold text-slate-900 dark:text-white">
              {t.readSwitchTitle}
            </h2>
            <p className="mt-1 text-sm leading-relaxed text-slate-500 dark:text-zinc-500">
              {t.readSwitchText}
            </p>
          </div>
          <button
        ...
        <div className="mt-5 space-y-2">
          <button
            ...
            className="w-full rounded-xl bg-emerald-600 px-3 py-2.5 text-left transition hover:bg-emerald-700"
          >
            <span className="block text-sm font-bold text-white">{t.readSwitchContinue}</span>
            <span className="mt-0.5 block text-xs leading-snug text-emerald-100">
          ...
          <button
            type="button"
            onClick={onExplore}
            className="flex w-full items-start gap-2 rounded-xl border border-slate-200 px-3 py-2.5 text-left transition hover:bg-slate-50 dark:border-zinc-800 dark:hover:bg-zinc-800/60"
          >
            ...
            <span className="min-w-0">
              ...
              <span className="mt-0.5 block text-xs leading-snug text-slate-500 dark:text-zinc-500">

...
export default function Navbar() {
  ...
  return (
    <header
      className="site-header fixed inset-x-0 top-0 lg:left-[260px] z-50 border-b border-slate-200/80 bg-white/95 shadow-sm backdrop-blur-md transition-colors dark:border-zinc-800 dark:bg-zinc-950/95 "

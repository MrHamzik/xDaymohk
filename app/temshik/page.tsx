...
/**
 * /temshik — «Темщик»: задания за вознаграждение (isPaid = true).
 *
 * Тот же движок заданий, что и «Помощь» (/goncholla), разница только в
 * флаге оплаты. По-чеченски раздел называется «Теманаш лелориг» — это
 * перевод, а не второе имя: русская подпись везде «Темщик».
 */
...
export default function TemshikPage() {
  const { t } = useI18n();
